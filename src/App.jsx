...
export default function App() {
  // single, consistent "started" state for menu -> game
  const [started, setStarted] = useState(false);

  // main game states (kept identical to your working version)
      ...
      <AnimatePresence mode="wait">
        ...
        {!started && (
          ...
          >
            ...
            <p className="text-lg text-indigo-100 mb-10">Developed by Jeffrey Munroe</p>
          ...
          >
            ...
            <div className="flex gap-8 mt-8 items-center">
              {["team1", "team2"].map((team, i) => (
                <div key={team} className="bg-indigo-600 px-6 py-4 rounded-2xl shadow-lg text-2xl">
                  Team {i + 1}:{" "}
                  <motion.span
                    key={scores[team]}
                    initial={{ scale: 0.85 }}
            ...
            <div className="mt-6 text-center">
              ...
              <div className="flex gap-3 justify-center">
                <button onClick={addStrike} className="bg-red-600 px-6 py-2 rounded-xl font-bold shadow hover:bg-red-500">
                  Add Strike
                </button>
                <button
                  onClick={() =>
              ...
              <AnimatePresence>
                {stealMode && (
                  ...
                  >
                    ...
                    <div className="flex gap-3 justify-center">
                      <button onClick={() => awardPoints("team1")} className="bg-green-600 px-4 py-2 rounded-lg font-semibold">
                        Award to Team 1
                      </button>
                      <button onClick={() => awardPoints("team2")} className="bg-green-600 px-4 py-2 rounded-lg font-semibold">
                        Award to Team 2
                      </button>
                    </div>
                  </motion.div>
            ...
            <div className="flex gap-4 mt-8">
              <button onClick={nextRound} className="bg-yellow-400 text-black px-6 py-3 rounded-xl font-bold shadow hover:bg-yellow-300">
                Next Round ➡️
              </button>
              <button onClick={resetGame} className="bg-red-500 text-white px-6 py-3 rounded-xl font-bold shadow hover:bg-red-400">
                Reset Game 🔄
              </button>
            </div>

            {/* Footer */}
            <footer className="mt-8 text-sm text-indigo-200 opacity-80">
              Developed by Jeffrey Munroe © {new Date().getFullYear()}
            </footer>
          </motion.div>
        )}
      </AnimatePresence>
